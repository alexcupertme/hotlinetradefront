...
const ProductOrders = (props) => {
  ...
  useEffect(() => {
    setData(db_data.product_orders);
  }, []);

  const options = {
      labels: ["Транспорт", "Категория", "Другое"],
      plotOptions: {
        radialBar: {
          size: 150,
          hollow: {
  ...
  return data !== null ? (
    <Card>
      <CardHeader>
        <CardTitle tag="h4">Заработано</CardTitle>
      ...
      <CardBody>
        ...
        <div className="d-flex justify-content-between mb-1">
          <div className="d-flex align-items-center">
            ...
            <span className="fw-bold ms-75">Транспорт</span>
          </div>
        ...
        <div className="d-flex justify-content-between mb-1">
          <div className="d-flex align-items-center">
            ...
            <span className="fw-bold ms-75">Категория</span>
          </div>
        ...
        <div className="d-flex justify-content-between">
          <div className="d-flex align-items-center">
            ...
            <span className="fw-bold ms-75">Другое</span>
          </div>
